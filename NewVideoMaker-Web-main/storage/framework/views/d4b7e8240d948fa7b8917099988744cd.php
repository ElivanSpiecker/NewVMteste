    ...
    <div class="mt-10 grid gap-10 lg:grid-cols-[1fr_380px]">
        <form action="<?php echo e(route('videos.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <input id="tema" type="text" name="tema" value="<?php echo e(old('tema')); ?>" maxlength="200" required placeholder="<?php echo e(__('ex: café artesanal, energia solar, música independente...')); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div id="imagens_upload_wrap" class="mt-4 hidden">
                    <label class="form-label" for="imagens"><?php echo e(__('Arquivos de imagem (uma por cena, em ordem)')); ?></label>
                    <input id="imagens" type="file" name="imagens[]" accept="image/*" multiple class="form-control">
                    <p class="mt-1 text-xs text-muted-foreground"><?php echo e(__('JPG, PNG ou WebP. Até 20 imagens, 10 MB cada.')); ?></p>
