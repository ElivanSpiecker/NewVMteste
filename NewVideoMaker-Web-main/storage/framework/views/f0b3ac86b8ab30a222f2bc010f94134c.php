<?php $__env->startSection('title', __('Meus Vídeos') . ' — NEW VideoMaker'); ?>
<?php $__env->startSection('description', __('Todos os vídeos gerados na plataforma.')); ?>

<?php $__env->startSection('content'); ?>
<div class="min-h-screen p-8 lg:p-12">
    <div class="flex flex-wrap items-start justify-between gap-4">
        <div>
            <h1 class="font-display text-4xl font-bold tracking-tight text-foreground lg:text-5xl"><?php echo e(__('Meus Vídeos')); ?></h1>
            <p class="mt-2 text-sm text-muted-foreground"><?php echo e(__('Todos os vídeos gerados na plataforma.')); ?></p>
        </div>
        <a href="<?php echo e(route('videos.create')); ?>" class="btn-primary">
            <i data-lucide="plus" class="h-4 w-4"></i>
            <?php echo e(__('Novo vídeo')); ?>
    ...
    <div class="mt-8 flex flex-wrap items-center gap-3">
        ...
        <div class="relative ml-auto">
            ...
            <input id="videoSearch" type="text" placeholder="<?php echo e(__('Buscar por tema...')); ?>" class="w-56 rounded-sm border border-border bg-card py-2 pl-9 pr-3 text-xs text-foreground outline-none transition-colors focus:border-foreground">
        </div>
    </div>
    ...
    <div id="videosGrid" class="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div class="col-span-full rounded-sm border border-dashed border-border p-16 text-center">
                ...
                <p class="mt-4 text-sm text-muted-foreground"><?php echo e(__('Nenhum vídeo gerado ainda.')); ?></p>
                <a href="<?php echo e(route('videos.create')); ?>" class="btn-primary mt-6"><?php echo e(__('Gerar primeiro vídeo')); ?></a>
            </div>
        <?php endif; ?>
    </div>
</div>
...
<script>
    const FILTER_ALL = <?php echo json_encode(__('Todos'), 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\nicol\PycharmProjects\NewVMteste\NewVideoMaker-Web-main\resources\views/videos/index.blade.php ENDPATH**/ ?>